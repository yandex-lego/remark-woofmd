            ...
            switch (state) {
                ...
                case S_CELL:
                    ...
                    if (ch === CH_PIPE) {
                        ...
                        const charCodeAfterPipes2 = value.charCodeAt(i + pipes + 1);

                        // Prevent troubles if the last
                        if (charCodeAfterPipes === CH_HASH && /* womMonospace */charCodeAfterPipes2 !== CH_HASH) {
                ...
                case S_EXT:
                    ...
                    } else if (ch === CH_HASH && ch1 === CH_HASH) {
                        // skip womMonospace (##...##)
                        i += 1;
                    }
