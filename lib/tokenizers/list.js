...
var EXPRESSION_WOM_BULLET = /^([ \t]*)([*+-]|[A-Za-z\d]+[.)])( {1,4}(?! )| |\t|$|(?=\n))([^\n]*)/;
...
function list(eat, value, silent) {
    ...
    while (++index < length) {
        ...
        item = eat(item)(listItem(self, item, now, wom), node);
...
function listItem(ctx, value, position, wom) {
...
function normalListItem(ctx, value, position, wom) {
    ...
    /* Remove the list-item’s bullet. */
    var bullet = wom ? EXPRESSION_WOM_BULLET : EXPRESSION_BULLET;
